...
c.colors.completion.even.bg = nord_base02
c.colors.completion.odd.bg = nord_base02
...
c.colors.completion.item.selected.fg = nord_base03
c.colors.completion.item.selected.bg = nord_cyan
c.colors.completion.item.selected.border.top = nord_base03
c.colors.completion.item.selected.border.bottom = nord_base03
c.colors.completion.match.fg = nord_yellow
...
c.colors.tabs.selected.odd.fg = nord_base03
c.colors.tabs.selected.odd.bg = nord_blue
c.colors.tabs.selected.even.fg = nord_base03
c.colors.tabs.selected.even.bg = nord_blue
c.colors.downloads.bar.bg = nord_base02
c.colors.downloads.start.fg = nord_base01
c.colors.downloads.start.bg = nord_cyan
c.colors.downloads.stop.bg = nord_green
c.colors.downloads.error.fg = nord_base01
c.colors.downloads.error.bg = nord_red
c.colors.webpage.bg = nord_base2
c.colors.messages.error.fg = nord_base1
